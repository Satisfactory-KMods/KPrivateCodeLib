...
public:
	...
	UFUNCTION(Server, WithValidation, Reliable, BlueprintCallable)
	void Server_Faxit_SetFilterItem(class AKPCLNetworkConnectionBuilding* Target, TSubclassOf<UFGItemDescriptor> NewItem);
	bool Server_Faxit_SetFilterItem_Validate(class AKPCLNetworkConnectionBuilding* Target, TSubclassOf<UFGItemDescriptor> NewItem) { return true; }
	...
	bool Server_Faxit_SetSpeedOverride_Validate(class AKPCLNetworkConnectionBuilding* Target, float Value) { return true; }

	UFUNCTION(Server, WithValidation, Reliable, BlueprintCallable)
	void Server_Faxit_SetOverflowType(class AKPCLNetworkConnectionBuilding* Target, EKPCLOverflowMode NewMode);
	bool Server_Faxit_SetOverflowType_Validate(class AKPCLNetworkConnectionBuilding* Target, EKPCLOverflowMode NewMode) { return true; }
