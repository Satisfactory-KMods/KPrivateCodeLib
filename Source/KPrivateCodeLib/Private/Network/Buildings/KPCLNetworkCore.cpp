	...
	Data.Sort( [&]( const FCoreInventoryData& A, const FCoreInventoryData& B ) {
		switch( SortOption.mSorting ) {
			...
			case ECoreDataSortOption::formalphab:
				return UFGItemDescriptor::GetItemName( A.mItem ).ToString( ) < UFGItemDescriptor::GetItemName( B.mItem ).ToString( ) && UFGItemDescriptor::GetForm( A.mItem ) < UFGItemDescriptor::GetForm( B.mItem );
